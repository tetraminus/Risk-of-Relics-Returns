...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(RiskOfRelicsReturns.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(RiskOfRelicsReturns.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(RiskOfRelicsReturns.makeImagePath("masks/PowerMask.png"));
